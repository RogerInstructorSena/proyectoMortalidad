...
namespace proyectoMortalidad.Models
{
    ...
    public partial class CAUSA_666_PREGUNTA
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public CAUSA_666_PREGUNTA()
        {
            this.Variable = new HashSet<Variable>();
        }
    
        public decimal causa666PreguntaId { get; set; }
        public string causa666PreguntaNombre { get; set; }
        public string causa666PreguntaSigla { get; set; }
